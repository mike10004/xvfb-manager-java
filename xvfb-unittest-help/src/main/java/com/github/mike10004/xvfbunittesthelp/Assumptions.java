...
import com.github.mike10004.xvfbunittesthelp.Assumer.FatalAssumer;
...
public class Assumptions {
    ...
    public static final String DEFAULT_ASSUMER = Assumer.JUnitAssumer.class.getName();
    public static final String FATAL_ASSUMER = Assumer.FatalAssumer.class.getName();

    private static final Supplier<Assumer> assumerSupplier = Suppliers.memoize(new Supplier<Assumer>() {
        @Override
        public Assumer get() {
